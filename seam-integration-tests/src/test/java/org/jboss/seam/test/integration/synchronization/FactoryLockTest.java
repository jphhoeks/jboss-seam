...
public class FactoryLockTest extends JUnitSeamTest {
	...
	public static Archive<?> createDeployment() {
		return Deployments.defaultSeamDeployment().addClasses(FactoryLockAction.class, FactoryLockLocal.class, TestProducer.class,
				SeamSynchronizedFactoryLockAction.class, KnitFactory.class, PurlFactory.class);
	}
	...
	@Test
	public void factoryLock() throws Exception {
	...
	public void sameFactoryLock() throws Exception {
		multiThreadedTest(new TestThread() {
			@Override
			public void runTest() throws Exception {
	...
	@Ignore // JBSEAM-5001
	@Test
	public void seamSynchronizedFactoryLock() throws Exception {
		multiThreadedTest(new TestThread() {
			@Override
			public void runTest() throws Exception {
	...
	@Test
	public void interleavingFactories() throws Exception {
		multiThreadedTest(new TestThread() {
			@Override
			public void runTest() throws Exception {
