...
public class RedirectTest {
	...
	public static Archive<?> createDeployment() {
		...
		return Deployments.realSeamDeployment().addClasses(MyComponent.class, MyException.class)
