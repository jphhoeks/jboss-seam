...
public class SFSBSynchronizationTest {
	...
	public static Archive<?> createDeployment() {
		...
		return Deployments.realSeamDeployment().addClasses(TestAction.class, TestLocal.class)
				.addAsWebResource(new StringAsset("<html xmlns=\"http://www.w3.org/1999/xhtml\""
						+ " xmlns:s=\"http://jboss.org/schema/seam/taglib\"" + " xmlns:h=\"http://java.sun.com/jsf/html\""
						+ " xmlns:f=\"http://java.sun.com/jsf/core\">" + "<h:head></h:head>" + "<h:body>"
						+ "<h:outputText value=\"#{test.test1()} \" /><h:outputText value=\"#{test.test2()}\" />" + "</h:body>"
						+ "</html>"), "test.xhtml");
	}
	...
	@Test
	public void synchronizationInterceptor() throws Exception {
