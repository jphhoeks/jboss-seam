...
public class ConcurrentFactoryTest extends JUnitSeamTest {
	...
	@Test(timeout = 10000)
	public void concurrentFactoryCall() throws Exception {
	...
	static public class LockHoldingComponent implements Serializable {
		...
		@In(value = "concurrentFactoryTest.slowlyCreatedComponent", create = true)
		SlowlyCreatedComponent slowlyCreatedComponent;
