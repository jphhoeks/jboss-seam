...
public class NamespaceResolverTest extends JUnitSeamTest {
	...
	public void testResolver() {
		...
		test("java:foo", "foo");
		test("java:com.company.department", "com.company.department");
		test("java:com.company.department.product", "com.company.department.product");
		test("http://www.company.com/department/product", "com.company.department.product");
		test("https://my-company.com/department/product", "com.my_company.department.product");
		test("http://ericjung:password@www.company.com:8080/foo/bar/baz#anchor?param1=332&param2=334", "com.company.foo.bar.baz");
		test("http://cats.import.com", "com.import.cats");
