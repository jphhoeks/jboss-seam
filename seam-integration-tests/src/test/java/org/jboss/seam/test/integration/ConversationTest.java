...
public class ConversationTest extends JUnitSeamTest {
	...
	@Test
	public void conversationStack() throws Exception {
	...
	@Test
	public void conversationList() throws Exception {
		new FacesRequest("/pageWithDescription.xhtml") {
			@Override
			protected void renderResponse() throws Exception {
	...
	public void nestedKillAllOthers() throws Exception {
		...
		new FacesRequest("/pageWithDescription.xhtml", root) {
			...
			protected void renderResponse() throws Exception {
				...
				Manager.instance().killAllOtherConversations();
				Assert.assertEquals(2, ConversationEntries.instance().size());
				Assert.assertEquals(true, ConversationEntries.instance().getConversationIds().contains(unrelated) == false);
			}
