...
public class ViewUrlBuilderTest {
	...
	public static Archive<?> createDeployment() {
		...
		war.addAsWebInfResource(new StringAsset("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				...
				+ "<page view-id=\"/testslink.xhtml\">" + "<rewrite pattern=\"/testslink/{input}\" />"
				+ "<rewrite pattern=\"/testslink\" />" + "<param name=\"input\" value=\"#{testslink.input}\"/>" + "</page></pages>"),
				"pages.xml").addAsWebResource("testslink.xhtml", "testslink.xhtml")
