...
public class ConversationPropagationsTest {
	...
	public static Archive<?> createDeployment() {
		...
		war.addAsWebResource("org/jboss/seam/test/integration/faces/conversations/conversations.xhtml", "conversations.xhtml")
	...
	private void testScenario(String output, String... ids) throws FailingHttpStatusCodeException, MalformedURLException, IOException {
		HtmlPage page = client.getPage(contextPath + "conversations.seam");
	...
	private void testCommonScenario(String output, String... ids)
	...
	public void testConversationEndingException() throws Exception {
		testCommonScenario("Output: begin;xyzzy;raiseConversationEndingException;. Conversation: false.", "conversation_ending_exception");
	}
