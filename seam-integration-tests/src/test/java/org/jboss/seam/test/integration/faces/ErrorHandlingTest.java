	...
	public static Archive<?> createDeployment() {
		...
		war.addClasses(TestComponent.class, TestException.class)
				.addAsWebResource(new StringAsset("<html xmlns=\"http://www.w3.org/1999/xhtml\""
						...
						+ "<h:commandButton id='throwAjax' action='#{testComponent.throwTestException}' value='Throw Ajax'>" + "<f:ajax/>"
						+ "</h:commandButton>" + "</h:form>" + "</h:body>" + "</html>"), "test.xhtml")
				.addAsWebResource(
						new StringAsset("<html xmlns=\"http://www.w3.org/1999/xhtml\"" + " xmlns:h=\"http://java.sun.com/jsf/html\""
								...
								+ " Exception handled, state: <h:outputText value='#{testComponent.state}'/>" + "</h:body>" + "</html>"),
						"error.xhtml")
