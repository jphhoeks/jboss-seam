...
public class SecurityTest extends JUnitSeamTest {
	...
	private Configuration createMockJAASConfiguration() {
		return new Configuration() {
			private AppConfigurationEntry[] aces = { new AppConfigurationEntry(MockLoginModule.class.getName(),
	...
	public class MockIdentity extends Identity {
		...
		protected LoginContext getLoginContext() throws LoginException {
			return new LoginContext("default", getSubject(), getCredentials().createCallbackHandler(), createMockJAASConfiguration());
		}
	}
