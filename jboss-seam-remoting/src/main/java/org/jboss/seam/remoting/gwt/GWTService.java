...
public abstract class GWTService extends AbstractResource implements SerializationPolicyProvider {
	...
	*/
	...
	protected abstract String createResponse(ServerSerializationStreamWriter stream, Class responseType, Object responseObj,
			boolean isException);
			...
			new ContextualHttpServletRequest(request) {
				...
				protected void restoreConversationId() {
					ConversationPropagation.instance()
							.setConversationId(GWTService.this.perThreadRequest.get().getParameter("conversationId"));
				}
	...
	*/
	public String processCall(String payload) throws SerializationException {
		...
		try {
			...
			return RPC_invokeAndEncodeResponse(this, rpcRequest.getMethod(), rpcRequest.getParameterTypes(), rpcRequest.getParameters(),
	...
	*            </ul>
	*/
	public static SeamRPCRequest RPC_decodeRequest(String encodedRequest, Class<?> type,
		...
		try {
			...
			for (int i = 0; i < parameterTypes.length; i++) {
				...
				try {
					...
					throw new IncompatibleRemoteServiceException("Parameter " + i + " of is of an unknown type '" + paramClassName + "'",
							e);
				}
			}
	...
	*/
	public static String RPC_invokeAndEncodeResponse(Object target, Method serviceMethod, Class[] paramTypes, Object[] args,
		...
		try {
			...
			GWTToSeamAdapter.ReturnedObject returnedObject = adapter.callWebRemoteMethod(serviceIntfName, serviceMethod.getName(),
					paramTypes, args);
	...
	*/
	...
	public final SerializationPolicy getSerializationPolicy(String moduleBaseURL, String strongName) {
		...
		if (serializationPolicy == null) {
			...
			getServletContext().log("WARNING: Failed to get the SerializationPolicy '" + strongName + "' for module '" + moduleBaseURL
	...
	*/
	protected SerializationPolicy doGetSerializationPolicy(HttpServletRequest request, String moduleBaseURL, String strongName) {
		...
		if (modulePath == null || !modulePath.startsWith(contextPath)) {
			String message = "ERROR: The module path requested, " + modulePath + ", is not in the same web application as this servlet, "
					+ contextPath + ".  Your module may not be properly configured or your client and server code maybe out of date.";
	...
	private void RemoteServiceServlet_writeResponse(HttpServletRequest request, HttpServletResponse response, String responsePayload)
			throws IOException {
