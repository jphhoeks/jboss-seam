...
public class ManagedEntityWrapper {
	...
	public void wrap(Object target, Component component) throws Exception {
		if (!touchedContextsExist()) {
			log.trace(
					"No touched persistence contexts. Therefore, there are no entities in this conversation whose identities need to be preserved.");
			return;
		}
	...
	public void deserialize(Object controllerBean, Component component) throws Exception {
		if (!touchedContextsExist()) {
			log.trace(
					"No touched persistence contexts. Therefore, there are no entities in this conversation whose identities need to be restored.");
			return;
		}
