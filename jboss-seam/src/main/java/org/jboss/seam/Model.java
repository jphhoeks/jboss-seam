...
/**
 * Base class of metamodels. For a class which is neither an entity nor a Seam
 * component, the concrete type of the metamodel object will be Model. For
 * components or entities it is a subclass of Model.
 * 
 * @author Gavin King
 *
 */
