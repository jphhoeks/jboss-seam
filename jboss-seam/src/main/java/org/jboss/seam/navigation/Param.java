...
public final class Param {
	...
	*/
	...
	private FacesMessage createMessage(Set<ConstraintViolation<Object>> invalidValues) {
		...
		return FacesMessages.createFacesMessage(FacesMessage.SEVERITY_ERROR, INVALID_MESSAGE_ID,
				"'" + name + "' parameter is invalid: " + message, new Object[] { message, name });
	}

	private FacesMessage createMessage(Throwable cause) {
		return FacesMessages.createFacesMessage(FacesMessage.SEVERITY_ERROR, INVALID_MESSAGE_ID,
				"'" + name + "' parameter is invalid: " + cause.getMessage(), new Object[] { cause.getMessage(), name });
	}
