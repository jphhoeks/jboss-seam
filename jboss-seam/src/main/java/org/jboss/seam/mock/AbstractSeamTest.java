...
public class AbstractSeamTest {
	...
	*/
	abstract class Request {
		 ...
		 */
		protected void setValue(String valueExpression, Object value) {
			application.getExpressionFactory().createValueExpression(facesContext.getELContext(), valueExpression, Object.class)
		...
		protected HttpServletRequest createRequest() {
			...
			return new MockHttpServletRequest(session, getPrincipalName(), getPrincipalRoles(), cookieArray,
