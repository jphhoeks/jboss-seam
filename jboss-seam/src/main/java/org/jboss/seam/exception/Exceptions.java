...
public class Exceptions {
	...
	private ExceptionHandler createHandler(Element exception, final Class<?> clazz) {
		...
		if (redirect != null) {
			...
			return new ConfigRedirectHandler(viewId == null ? null : Expressions.instance().createValueExpression(viewId, String.class),
					clazz, endConversation, endConversationBeforeRedirect, message, severity);
		}
