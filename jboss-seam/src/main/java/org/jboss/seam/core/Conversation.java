...
public class Conversation implements Serializable {
	...
	*/
	public Integer getTimeout() {
		return timeout == null ? Manager.instance().getCurrentConversationTimeout() : timeout;
	}
	...
	*/
	...
	public Integer getConcurrentRequestTimeout() {
		return concurrentRequestTimeout == null ? Manager.instance().getCurrentConversationConcurrentRequestTimeout()
	...
	*/
	...
	public String getDescription() {
		return description == null ? Manager.instance().getCurrentConversationDescription() : description;
	}

	public String getViewId() {
		return viewId == null ? Manager.instance().getCurrentConversationViewId() : viewId;
	}
