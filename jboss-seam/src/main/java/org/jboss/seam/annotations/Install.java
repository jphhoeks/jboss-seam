...
public @interface Install {
	...
	/**
	 * Precedence to use for components which override application components in
	 ...
	 * 
	 * @return indicates that the component should only be installed in debug
	 *         mode
	 */
	boolean debug() default false;

	/**
	 * Indicates that the component should not be installed unless the dependent
	...
	/**
	 * Indicates that the component should not be installed unless the the given
	 * class definitions are available on the classpath
	 * 
	...
	/**
	 * The precedence of the component. If multiple components with the same
	 * name exist, the one with the higher precedence will be installed.
	 */
