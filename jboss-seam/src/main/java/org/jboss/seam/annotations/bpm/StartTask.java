...
/**
 * Marks a method as causing jBPM {@link org.jbpm.taskmgmt.exe.TaskInstance
 * task} to be started. The jBPM {@link org.jbpm.context.exe.ContextInstance} is
 ...
 * {@link org.jboss.seam.contexts.BusinessProcessContext}; {@link StartTask}
 * however, also has effect after method invocation as that is the time it
 * actually marks the task as started.
 *
