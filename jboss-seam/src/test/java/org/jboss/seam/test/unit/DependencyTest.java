...
public class DependencyTest {
	...
	private void addDependency(Map<String, Set<ComponentDescriptor>> dependencies, ComponentDescriptor descriptor) {
	...
	static class MockDescriptor extends ComponentDescriptor {
		...
		public String[] getClassDependencies() {
			return (classDependencies != null) ? classDependencies : super.getClassDependencies();
		}
		...
		public String[] getDependencies() {
			return (dependencies != null) ? dependencies : super.getDependencies();
		}
		...
		public Class[] getGenericDependencies() {
			return (genericDependencies != null) ? genericDependencies : super.getGenericDependencies();
		}
	}
