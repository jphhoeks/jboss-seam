...
public class PageActionsTest extends AbstractPageTest {
	...
	*/
	...
	private void assertViewId(FacesContext facesContext, String expectedViewId) {
		...
		assert expectedViewId.equals(actualViewId) : "Expected viewId to be " + expectedViewId + ", but got " + actualViewId;
	}
	...
	private void assertActionCalls(TestActions testActions, String[] methodNames) {
		...
		assert expectedMethodCalls.equals(actualMethodCalls) : "Expected actions to be called: " + expectedMethodCalls
				+ "; actions actually called: " + actualMethodCalls;
