...
public class RewriteTest {
	@Test
	public void testBasicInPattern() throws Exception {
	...
	@Test
	public void testSingleArgInPattern() throws Exception {
	...
	@Test
	public void testMultiArgInPattern() throws Exception {
	...
	@Test
	public void testBasicOutPattern() throws Exception {
		Pattern pattern = new Pattern("/foo.seam", "/foo");
		pattern.setViewMapping(new ServletMapping("*.seam"));
	...
	@Test
	public void testSingleArgOutPattern() throws Exception {
		Pattern pattern = new Pattern("/foo.seam", "/foo/{id}");
		pattern.setViewMapping(new ServletMapping("*.seam"));
	...
	@Test
	public void testMultiArgOutPattern() throws Exception {
		Pattern pattern = new Pattern("/foo.seam", "/foo/{id}/{action}");
		pattern.setViewMapping(new ServletMapping("*.seam"));
