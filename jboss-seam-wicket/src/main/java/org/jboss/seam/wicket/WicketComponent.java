...
public class WicketComponent<T> {
	...
	private void add(Constructor<T> constructor) {
		if (constructor.isAnnotationPresent(Begin.class) || constructor.isAnnotationPresent(org.jboss.seam.wicket.annotations.Begin.class)
				|| constructor.isAnnotationPresent(End.class) || constructor.isAnnotationPresent(StartTask.class)
				|| constructor.isAnnotationPresent(BeginTask.class) || constructor.isAnnotationPresent(EndTask.class)) {
	...
	private void add(Method method) {
		...
		if (method.isAnnotationPresent(Begin.class) || method.isAnnotationPresent(org.jboss.seam.wicket.annotations.Begin.class)
				|| method.isAnnotationPresent(End.class) || method.isAnnotationPresent(StartTask.class)
	...
	public boolean isConversationManagementMethod(AccessibleObject member) {
		return member != null && conversationManagementMembers.contains(member);
	}
