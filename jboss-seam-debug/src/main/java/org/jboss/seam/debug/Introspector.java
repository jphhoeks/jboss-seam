...
public class Introspector {
	...
	public Attribute[] getAttributes() throws Exception {
		...
		if (component == null) {
			...
			return getMapAttributes((Map<Object, Object>) component);
		} else if (component instanceof List) {
			return getListAttributes((List<Object>) component);
		} else {
	...
	public Attribute[] getListAttributes(List<Object> list) {
	...
	private Attribute[] getComponentAttributes(Object component) throws IntrospectionException, IllegalAccessException {
		...
		for (int i = 0; i < properties.length; i++) {
			...
			boolean convertArrayToList = value != null && value.getClass().isArray()
