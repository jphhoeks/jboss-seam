...
public class UICell extends UICellBase implements WorksheetItem {
	...
	*/
	public CellType getDataType() {
		...
		if (value instanceof Integer || value instanceof Long || value instanceof Double || value instanceof Short
				|| value instanceof BigDecimal || value instanceof BigInteger || value instanceof Byte || value instanceof Float) {
