...
public final class HTML {
	// Common attributes
		...
		public static final String[] EVENT_HANDLER_ATTRIBUTES_WITHOUT_ONCLICK = { ONDBLCLICK_ATTR, ONMOUSEDOWN_ATTR, ONMOUSEUP_ATTR,
				ONMOUSEOVER_ATTR, ONMOUSEMOVE_ATTR, ONMOUSEOUT_ATTR, ONKEYPRESS_ATTR, ONKEYDOWN_ATTR, ONKEYUP_ATTR };
		public static final String[] EVENT_HANDLER_ATTRIBUTES = concat(EVENT_HANDLER_ATTRIBUTES_WITHOUT_ONCLICK, new String[] { ONCLICK_ATTR });
		...
		public static final String[] COMMON_FIELD_EVENT_ATTRIBUTES = { ONFOCUS_ATTR, ONBLUR_ATTR, ONSELECT_ATTR, ONCHANGE_ATTR };
		public static final String[] COMMON_FIELD_EVENT_ATTRIBUTES_WITHOUT_ONFOCUS = { ONBLUR_ATTR, ONSELECT_ATTR, ONCHANGE_ATTR };
		...
		public static final String[] UNIVERSAL_ATTRIBUTES_WITHOUT_STYLE = { DIR_ATTR, LANG_ATTR, TITLE_ATTR,
				//NOTE: if changed, please verify universal attributes in HtmlMessageRenderer !
		};
		public static final String[] UNIVERSAL_ATTRIBUTES = concat(UNIVERSAL_ATTRIBUTES_WITHOUT_STYLE,
		...
		public static final String[] COMMON_FIELD_ATTRIBUTES_WITHOUT_DISABLED = { ACCESSKEY_ATTR, TABINDEX_ATTR };
		public static final String[] COMMON_FIELD_ATTRIBUTES = concat(COMMON_FIELD_ATTRIBUTES_WITHOUT_DISABLED, new String[] { DISABLED_ATTR });
		// Common Attributes
		public static final String[] COMMON_PASSTROUGH_ATTRIBUTES = concat(EVENT_HANDLER_ATTRIBUTES, UNIVERSAL_ATTRIBUTES);
		public static final String[] COMMON_PASSTROUGH_ATTRIBUTES_WITHOUT_STYLE = concat(EVENT_HANDLER_ATTRIBUTES,
				UNIVERSAL_ATTRIBUTES_WITHOUT_STYLE);
		public static final String[] COMMON_PASSTROUGH_ATTRIBUTES_WITHOUT_ONCLICK = concat(EVENT_HANDLER_ATTRIBUTES_WITHOUT_ONCLICK,
				UNIVERSAL_ATTRIBUTES);
		public static final String[] COMMON_PASSTROUGH_ATTRIBUTES_WITHOUT_ONCLICK_WITHOUT_STYLE = concat(
				EVENT_HANDLER_ATTRIBUTES_WITHOUT_ONCLICK, UNIVERSAL_ATTRIBUTES_WITHOUT_STYLE);
		public static final String[] COMMON_FIELD_PASSTROUGH_ATTRIBUTES_WITHOUT_DISABLED = concat(COMMON_PASSTROUGH_ATTRIBUTES,
				COMMON_FIELD_ATTRIBUTES_WITHOUT_DISABLED, COMMON_FIELD_EVENT_ATTRIBUTES);
		public static final String[] COMMON_FIELD_PASSTROUGH_ATTRIBUTES_WITHOUT_DISABLED_AND_ONFOCUS = concat(COMMON_PASSTROUGH_ATTRIBUTES,
				COMMON_FIELD_ATTRIBUTES_WITHOUT_DISABLED, COMMON_FIELD_EVENT_ATTRIBUTES_WITHOUT_ONFOCUS);
		public static final String[] COMMON_FIELD_PASSTROUGH_ATTRIBUTES_WITHOUT_DISABLED_AND_ONFOCUS_AND_ONCLICK = concat(
				COMMON_PASSTROUGH_ATTRIBUTES_WITHOUT_ONCLICK, COMMON_FIELD_ATTRIBUTES_WITHOUT_DISABLED,
				COMMON_FIELD_EVENT_ATTRIBUTES_WITHOUT_ONFOCUS);
		public static final String[] COMMON_FIELD_PASSTROUGH_ATTRIBUTES_WITHOUT_DISABLED_AND_ONCLICK = concat(
				COMMON_PASSTROUGH_ATTRIBUTES_WITHOUT_ONCLICK, COMMON_FIELD_ATTRIBUTES_WITHOUT_DISABLED, COMMON_FIELD_EVENT_ATTRIBUTES);
		// <a>
		...
		public static final String[] ANCHOR_ATTRIBUTES = { ACCESSKEY_ATTR, CHARSET_ATTR, COORDS_ATTR, HREFLANG_ATTR, REL_ATTR, REV_ATTR,
				SHAPE_ATTR, TABINDEX_ATTR, TARGET_ATTR, TYPE_ATTR };
		public static final String[] ANCHOR_PASSTHROUGH_ATTRIBUTES = concat(ANCHOR_ATTRIBUTES, COMMON_PASSTROUGH_ATTRIBUTES);
		public static final String[] ANCHOR_PASSTHROUGH_ATTRIBUTES_WITHOUT_STYLE = concat(ANCHOR_ATTRIBUTES,
				COMMON_PASSTROUGH_ATTRIBUTES_WITHOUT_STYLE);
		public static final String[] ANCHOR_PASSTHROUGH_ATTRIBUTES_WITHOUT_ONCLICK_WITHOUT_STYLE = concat(ANCHOR_ATTRIBUTES,
		...
		public static final String[] FORM_ATTRIBUTES = { ACCEPT_ATTR, ACCEPT_CHARSET_ATTR, ENCTYPE_ATTR, ONRESET_ATTR, ONSUMBIT_ATTR,
				TARGET_ATTR, };
		public static final String[] FORM_PASSTHROUGH_ATTRIBUTES = concat(FORM_ATTRIBUTES, COMMON_PASSTROUGH_ATTRIBUTES);
		// <img>
		...
		public static final String[] IMG_ATTRIBUTES = { ALIGN_ATTR, ALT_ATTR, BORDER_ATTR, HEIGHT_ATTR, HSPACE_ATTR, ISMAP_ATTR, LONGDESC_ATTR,
				USEMAP_ATTR, VSPACE_ATTR, WIDTH_ATTR };
		public static final String[] IMG_PASSTHROUGH_ATTRIBUTES = concat(IMG_ATTRIBUTES, COMMON_PASSTROUGH_ATTRIBUTES);
		// <input>
		...
		public static final String[] INPUT_ATTRIBUTES = { ALIGN_ATTR, ALT_ATTR, CHECKED_ATTR, DATAFLD_ATTR, DATASRC_ATTR, DATAFORMATAS_ATTR,
				MAXLENGTH_ATTR, READONLY_ATTR, SIZE_ATTR, AUTOCOMPLETE_ATTR };
		public static final String[] INPUT_PASSTHROUGH_ATTRIBUTES_WITHOUT_DISABLED = concat(INPUT_ATTRIBUTES,
				COMMON_FIELD_PASSTROUGH_ATTRIBUTES_WITHOUT_DISABLED);
		public static final String[] INPUT_PASSTHROUGH_ATTRIBUTES_WITHOUT_DISABLED_AND_ONFOCUS_AND_ONCLICK = concat(INPUT_ATTRIBUTES,
		...
		// <button>
		public static final String[] BUTTON_ATTRIBUTES = { ALIGN_ATTR, ALT_ATTR, DATAFLD_ATTR, DATASRC_ATTR, DATAFORMATAS_ATTR, };
		public static final String[] BUTTON_PASSTHROUGH_ATTRIBUTES_WITHOUT_DISABLED = concat(BUTTON_ATTRIBUTES,
				COMMON_FIELD_PASSTROUGH_ATTRIBUTES_WITHOUT_DISABLED);
		public static final String[] BUTTON_PASSTHROUGH_ATTRIBUTES_WITHOUT_DISABLED_AND_ONCLICK = concat(BUTTON_ATTRIBUTES,
		...
		public static final String[] LABEL_ATTRIBUTES = { ACCESSKEY_ATTR, ONBLUR_ATTR, ONFOCUS_ATTR
				//FOR_ATTR is no pass through !
		};
		public static final String[] LABEL_PASSTHROUGH_ATTRIBUTES = concat(LABEL_ATTRIBUTES, COMMON_PASSTROUGH_ATTRIBUTES);
		// <select>
		public static final String MULTIPLE_ATTR = "multiple";
		public static final String[] SELECT_ATTRIBUTES = { DATAFLD_ATTR, DATASRC_ATTR, DATAFORMATAS_ATTR, };
		public static final String[] SELECT_PASSTHROUGH_ATTRIBUTES_WITHOUT_DISABLED = concat(SELECT_ATTRIBUTES,
				COMMON_FIELD_PASSTROUGH_ATTRIBUTES_WITHOUT_DISABLED);
		// <table>
		...
		public static final String[] TABLE_ATTRIBUTES = { ALIGN_ATTR, BGCOLOR_ATTR, BORDER_ATTR, CELLPADDING_ATTR, CELLSPACING_ATTR,
				DATAFLD_ATTR, DATASRC_ATTR, DATAFORMATAS_ATTR, FRAME_ATTR, RULES_ATTR, SUMMARY_ATTR, WIDTH_ATTR };
		public static final String[] TABLE_PASSTHROUGH_ATTRIBUTES = concat(TABLE_ATTRIBUTES, COMMON_PASSTROUGH_ATTRIBUTES);
		// <textarea>
		public static final String COLS_ATTR = "cols";
		public static final String ROWS_ATTR = "rows";
		public static final String[] TEXTAREA_ATTRIBUTES = { COLS_ATTR, DATAFLD_ATTR, DATASRC_ATTR, DATAFORMATAS_ATTR, READONLY_ATTR,
				ROWS_ATTR, };
		public static final String[] TEXTAREA_PASSTHROUGH_ATTRIBUTES_WITHOUT_DISABLED = concat(TEXTAREA_ATTRIBUTES,
				COMMON_FIELD_PASSTROUGH_ATTRIBUTES_WITHOUT_DISABLED);
		// <input type=file>
		public static final String[] INPUT_FILE_UPLOAD_ATTRIBUTES = { ACCEPT_ATTR };
		public static final String[] INPUT_FILE_PASSTHROUGH_ATTRIBUTES_WITHOUT_DISABLED = concat(INPUT_FILE_UPLOAD_ATTRIBUTES,
		...
		public static final String[] MESSAGE_PASSTHROUGH_ATTRIBUTES =
		    concat(
		        ...
		        */
		public static final String[] MESSAGE_PASSTHROUGH_ATTRIBUTES_WITHOUT_TITLE_STYLE_AND_STYLE_CLASS = concat(
				new String[] { DIR_ATTR, LANG_ATTR }, EVENT_HANDLER_ATTRIBUTES);
		// selectOne/Many table
		public static final String[] SELECT_TABLE_PASSTHROUGH_ATTRIBUTES = new String[] { STYLE_ATTR, STYLE_CLASS_ATTR, BORDER_ATTR };
		public static final String COMPACT_ATTR = "compact";
		public static final String[] UL_ATTRIBUTES = { COMPACT_ATTR, TYPE_ATTR };
		public static final String[] UL_PASSTHROUGH_ATTRIBUTES = concat(UL_ATTRIBUTES, COMMON_PASSTROUGH_ATTRIBUTES);
	...
	* @throws java.io.IOException
	*/
	public static boolean renderHTMLAttribute(ResponseWriter writer, UIComponent component, String componentProperty, String htmlAttrName)
			throws IOException {
	...
	* @throws java.io.IOException
	*/
	public static boolean renderHTMLAttribute(ResponseWriter writer, String componentProperty, String attrName, Object value)
			throws IOException {
