...
public class TokenRendererBase extends RendererBase {
	...
	protected void doDecode(FacesContext context, UIComponent component) {
		...
		if (context.getRenderKit().getResponseStateManager().isPostback(context) && form.isSubmitted()) {
			...
			if (!requestedViewSig
					.equals(generateViewSignature(context, form, !token.isAllowMultiplePosts(), token.isRequireSession(), clientToken))) {
	...
	protected void doEncodeBegin(ResponseWriter writer, FacesContext context, UIComponent component) throws IOException {
		...
		writer.writeAttribute(HTML.VALUE_ATTR, generateViewSignature(context, form, !token.isAllowMultiplePosts(), token.isRequireSession(),
	...
	*/
	...
	private String generateViewSignature(FacesContext context, UIForm form, boolean useRenderStamp, boolean useSessionId,
			String saltPhrase) {
